...
cd '/Users/kafizoa/Dropbox/mMIMO for HAPS/MatlabFiles/FunctionsHexagonal'
% User Parameters
...
antenna_array_positions=compute_hexagonal_array_positions(lambda, Nb, Nc, Nr, z_height);
