...
function [ResultD,ResultTheta]=cal_params_channel_bottom_panel(antenna_array_positions,group_users,z_height)
...
%         % Calculate azimuth angle
        delta_x = antenna_pos(1)-0;
        delta_y = antenna_pos(2)-0;
        azimuth_angle = atan2(delta_y,delta_x);  % Angle in radians

        antenna_direction = [0, 0, antenna_pos(3)-z_height];
